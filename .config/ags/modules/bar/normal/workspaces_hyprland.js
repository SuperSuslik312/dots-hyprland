        ...
        setup: (area) => area
            ...
            .on('draw', Lang.bind(area, (area, cr) => {
                ...
                for (let i = 1; i <= count; i++) {
                    ...
                    const wsLabel = userOptions.asyncGet().workspaces.labels[wsIndex] || `${wsIndex}`;
...
export default () => EventBox({
    ...
    child: Box({
        ...
        children: [Box({
            className: `bar-group${userOptions.asyncGet().appearance.borderless ? '-borderless' : ''} bar-group-standalone bar-group-pad`,
            css: 'min-width: 2px;',
